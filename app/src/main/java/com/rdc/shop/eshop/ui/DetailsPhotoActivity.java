...
import com.rdc.shop.eshop.adapter.PhotoPagerAdapter;
...
public class DetailsPhotoActivity<T> extends BaseActivity {
    ...
    public static <T> Intent newIntent(Context context, int index, List<T> list) {
        Intent intent = new Intent(context, DetailsPhotoActivity.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable(PHOTO_LIST, (ArrayList) list);
